...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="{{route('cat.create') }}"><button
            ...
            <table class="min-w-full divide-y divide-gray-700">
                <thead class="bg-gray-700">
                    <tr>
                        ...
                        <th scope="col"
                            class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Slug
                        </th>
                        <th scope="col"
                    ...
                    <tr class="hover:bg-gray-750 transition-colors">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <span class="text-xl mr-3">{{ $item->emojis }}</span>
                                <span class="text-gray-200 font-medium">{{ $item->name }}</span>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-gray-400">{{ $item->slug }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-gray-400">{{ $item->articles_count }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                           <a href="{{ route('cat.edit',$item->id) }}"><button class="text-purple-400 hover:text-purple-300 mr-4">Edit</button></a>
